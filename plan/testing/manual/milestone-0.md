...
mission-20260915-02, and nothing else. Every check here awaits an answer — none
have been carried forward from earlier results. Sections §1–§10 remain the record
of what was fixed and why it was fixed that way; §11 is the runnable pass — the
shortest route to confirming none of it has come undone. Start from a fresh
`npm start` unless a check says otherwise.
